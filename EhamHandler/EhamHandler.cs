...
namespace QTHmon
{
    public partial class EhamHandler : IEhamHandler
    {
        ...
        public EhamHandler(ILogger<HostedService> logger, IOptions<AppSettings> settings)
        {
            _logger = logger;
            _settings = settings.Value;
        }

        private async Task<Cookie> GetSessionCookie(HttpClient httpClient, CookieContainer cookies)
        {
